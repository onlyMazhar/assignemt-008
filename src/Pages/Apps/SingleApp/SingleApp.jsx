...
const SingleApp = ({ app }) => {
    ...
    return (
        <>
            ...
            <Link to={`/apps/${id}`}>
                <div className="h-full transition delay-100 duration-350 easy-in-out hover:translate-y-0.5 hover:scale-110 flex flex-col justify-around rounded-xl p-4 bg-base-100 mx-auto  shadow-md w-86  ">
                    <img
